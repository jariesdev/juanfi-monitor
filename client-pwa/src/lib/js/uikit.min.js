/*! UIkit 3.18.3 | https://www.getuikit.com | (c) 2014 - 2024 YOOtheme | MIT License */ (function (
	me,
	ve
) {
	typeof exports == 'object' && typeof module < 'u'
		...
		? define('uikit', ve)
		: ((me = typeof globalThis < 'u' ? globalThis : me || self), (me.UIkit = ve()));
})(this, function () {
	'use strict';
	...
	const Qo = /\B([A-Z])/g,
		...
		tr = /-(\w)/g,
		we = rt((t) => (t.charAt(0).toLowerCase() + t.slice(1)).replace(tr, (e, i) => i.toUpperCase())),
		It = rt((t) => t.charAt(0).toUpperCase() + t.slice(1));
	function dt(t, e) {
		var i;
	...
	function vt(t) {
		return $e(t) || (N(t) && !isNaN(t - parseFloat(t)));
	}
	function ti(t) {
	...
	function ne(t) {
		if (ie(t)) return t;
		t = F(t);
		const e = be(t) ? t : t == null ? void 0 : t.ownerDocument;
	...
	const Ri = { ratio: ji, contain: Ls, cover: er };
	...
	function p(t, e, i) {
		...
		for (const n of C(t))
			et(i) && (i = i.call(n, p(n, e))), i === null ? ye(n, e) : n.setAttribute(e, i);
	}
	function yt(t, e) {
	...
	function X(t, e) {
		for (const i of [e, `data-${e}`]) if (yt(t, i)) return p(t, i);
	}
	function $(t, ...e) {
		for (const i of C(t)) {
	...
	function qi(t, e) {
		e = new RegExp(e);
		for (const i of C(t)) i.classList.remove(...Tt(i.classList).filter((s) => s.match(e)));
	}
	function si(t, e, i) {
		(i = Ft(i)), (e = Ft(e).filter((s) => !m(i, s))), D(t, e), $(t, i);
	}
	function y(t, e) {
		return ([e] = Ft(e)), C(t).some((i) => i.classList.contains(e));
	}
	function j(t, e, i) {
		const s = Ft(e);
		G(i) || (i = !!i);
		for (const n of C(t)) for (const o of s) n.classList.toggle(o, i);
	}
	function Ft(t) {
	...
	function Ui(t) {
		return C(t).some((e) => ir[e.tagName.toLowerCase()]);
	}
	function q(t) {
		return C(t).some((e) => e.offsetWidth || e.offsetHeight || e.getClientRects().length);
	}
	const ke = 'input,select,textarea,button';
	function Vi(t) {
		return C(t).some((e) => E(e, ke));
	}
	...
	function Et(t, e) {
		return e ? C(t).indexOf(F(e)) : B(P(t)).indexOf(t);
	}
	function oe(t) {
	...
	function Ee(t, e) {
		return C(qs(t, F(e), 'querySelectorAll'));
	}
	const sr = /(^|[^\\],)\s*[!>+~-]/,
		js = rt((t) => t.match(sr));
	function Rs(t, e = document) {
		return (N(t) && js(t)) || be(e) ? e : e.ownerDocument;
	}
	const nr = /([!>+~-])(?=\s+[!>+~-]|\s*$)/g,
	...
	function g(t, e, i) {
		return Ki(t).every((s) => s.dispatchEvent(Ht(e, !0, !0, i)));
	}
	...
	function Ji(t) {
		return (
			(t[0] = Ki(t[0])), N(t[1]) && (t[1] = t[1].split(' ')), et(t[2]) && t.splice(2, 0, !1), t
		);
	}
	function hr(t, e) {
		return (i) => {
	...
	function Ki(t) {
		return Q(t) ? t.map(dr).filter(Boolean) : N(t) ? Ee(t) : Us(t) ? [t] : C(t);
	}
	function kt(t) {
	...
	function c(t, e, i, s) {
		...
		for (const o of n)
			if (N(e)) {
				...
				o.style.setProperty(e, vt(i) && !fr[e] ? `${i}px` : i || $e(i) ? i : '', s);
			} else if (Q(e)) {
				const r = {};
				...
				(o) =>
					new Promise((r, a) => {
						...
						H(
							...
							$(o, e, Pe + (n ? 'leave' : 'enter')),
							dt(e, Pe) && (s && $(o, `uk-transform-origin-${s}`), n && $(o, `${Pe}reverse`));
					})
			)
		);
	}
	const mr = new RegExp(`${Pe}(enter|leave)`),
		At = {
			in: Ys,
			out(t, e, i, s) {
				return Ys(t, e, i, s, !0);
	...
	function Lt(t, e) {
		return G(e) ? k(t).innerHTML : L(es(t), e);
	}
	const wr = ci('prepend'),
		L = ci('append'),
		li = ci('before'),
	...
	function is(t, e) {
		return C(C(t).map((i) => (i.hasChildNodes() ? ui(Tt(i.childNodes), e) : L(i, e))));
	}
	function _e(t) {
		C(t)
			.map(P)
	...
	function k(t, e) {
		return Xs(t) ? F(Wt(t)) : Gi(t, e);
	}
	function z(t, e) {
		return Xs(t) ? C(Wt(t)) : Ee(t, e);
	}
	function Xs(t) {
	...
	function Js(t) {
		...
		return (i, s) => {
			if (G(s)) {
				...
				return (
					(i = F(i)), (s = c(i, t)), (s = s === 'auto' ? i[`offset${e}`] : S(s) || 0), s - Ae(i, t)
				);
	...
	function Ae(t, e, i = 'border-box') {
		return c(t, 'boxSizing') === i
			? zt(jt[e].map(It), (s) => S(c(t, `padding${s}`)) + S(c(t, `border${s}Width`)))
			: 0;
	}
	function fi(t) {
	...
	function U(t, e = 'width', i = window, s = !1) {
		return N(t)
			? zt($r(t), (n) => {
					const o = kr(n);
					return o
						? Sr(o === 'vh' ? Ir() : o === 'vw' ? di(ne(i)) : s ? i[`offset${It(e)}`] : w(i)[e], n)
						: n;
			  })
			: S(t);
	}
	...
	function Ir() {
		return (
			...
			(re ||
				((re = k('<div>')),
				c(re, { height: '100vh', position: 'fixed' }),
				b(window, 'resize', () => (De = null))),
			L(document.body, re),
			(De = re.clientHeight),
			at(re),
			De)
	...
	const qt = typeof window < 'u',
		V = qt && document.dir === 'rtl',
		ae = qt && 'ontouchstart' in window,
		le = qt && window.PointerEvent,
		mt = le ? 'pointerdown' : ae ? 'touchstart' : 'mousedown',
		pi = le ? 'pointermove' : ae ? 'touchmove' : 'mousemove',
		Dt = le ? 'pointerup' : ae ? 'touchend' : 'mouseup',
		he = le ? 'pointerenter' : ae ? '' : 'mouseenter',
		Oe = le ? 'pointerleave' : ae ? '' : 'mouseleave',
		gi = le ? 'pointercancel' : 'touchcancel',
		K = {
			reads: [],
			writes: [],
			read(t) {
				return this.reads.push(t), os(), t;
			},
			write(t) {
				return this.writes.push(t), os(), t;
			},
			clear(t) {
	...
	function ns(t) {
		Ks(K.reads),
			...
			(K.scheduled = !1),
			(K.reads.length || K.writes.length) && os(t + 1);
	}
	const Tr = 4;
	function os(t) {
		K.scheduled ||
			((K.scheduled = !0),
			t && t < Tr ? Promise.resolve().then(() => ns(t)) : requestAnimationFrame(() => ns(1)));
	}
	function Ks(t) {
		let e;
		for (; (e = t.shift()); )
	...
	function Cr([{ x: t, y: e }, { x: i, y: s }], [{ x: n, y: o }, { x: r, y: a }]) {
	...
	const Er = qt && window.ResizeObserver;
	function Me(t, e, i = { box: 'border-box' }) {
	...
	function nn(t) {
		vi(t) && as(t, { func: 'playVideo', method: 'play' }), mi(t) && t.play();
	}
	function on(t) {
		vi(t) && as(t, { func: 'pauseVideo', method: 'pause' }), mi(t) && t.pause();
	}
	function rn(t) {
		vi(t) && as(t, { func: 'mute', method: 'setVolume', value: 0 }), mi(t) && (t.muted = !0);
	}
	function an(t) {
		return mi(t) || vi(t);
	}
		...
		return i.reduce(
			(r, a, l) => {
				const { scrollTop: h, scrollHeight: u, offsetHeight: d } = a,
					f = lt(a),
					v = u - f.height,
					{ height: x, top: T } = i[l - 1] ? lt(i[l - 1]) : I(t);
				let M = Math.ceil(T - f.top - e + h);
				return (
					e > 0 && d < x + e ? (M += e) : (e = 0),
		...
		function s(r, a, l, h) {
			return new Promise((u) => {
				...
				let M = 0,
					wt = 15;
				(function Ze() {
					const Bi = o(tt((Date.now() - v) / f));
					let ft = 0;
					if (i[0] === r && d + a < h) {
						ft = I(l).top + (x ? 0 : r.scrollTop) - T;
						const ge = hs(l);
						ft -= ge ? I(ge).height : 0;
					}
					(r.scrollTop = Math[a + ft > 0 ? 'max' : 'min'](r.scrollTop, d + (a + ft) * Bi)),
						Bi === 1 && (M === ft || !wt--) ? u() : ((M = ft), requestAnimationFrame(Ze));
				})();
			});
		}
		function n(r) {
	...
	function lt(t) {
		...
		for (let [n, o, r, a] of [
			...
			const l = s[n] % 1;
			(s[n] = s[o] = i[`client${It(n)}`] - (l ? (l < 0.5 ? -l : 1 - l) : 0)), (s[a] = s[n] + s[r]);
		}
		return s;
	}
	function hs(t) {
		const { left: e, width: i, top: s } = w(t);
		return t.ownerDocument.elementsFromPoint(e + i / 2, s).find(
			(n) =>
				!n.contains(t) &&
				!y(n, 'uk-togglable-leave') &&
				((cs(n, 'fixed') &&
					dn(
						Te(t)
							.reverse()
							.find((o) => !o.contains(n) && !cs(o, 'static'))
					) < dn(n)) ||
					(cs(n, 'sticky') && P(n).contains(t)))
		);
	}
	function dn(t) {
		return S(c(t, 'zIndex'));
	...
	function pn(t, e, i) {
		...
		for (const [l, [h, , u, d]] of Object.entries(ht)) {
			...
			if (r[l] === 'flip') {
				...
				v = Mr(t, e, i, l)[u] - s[u];
				const T = Or(t, e[l], o, l);
				if (!bi(ds(s, v, l), T, l)) {
					if (bi(s, T, l)) continue;
					if (i.recursion) return !1;
					const M = Br(t, e, i);
					if (M && bi(M, T, 1 - l)) return M;
					continue;
				}
			} else if (r[l] === 'shift') {
				const x = I(e[l]),
					{ offset: T } = i;
				v = tt(tt(s[u], f[u], f[d] - s[h]), x[u] - s[h] + T[l], x[d] - T[l]) - s[u];
			}
			a = ds(a, v, l);
		}
		return a;
	...
	function gn(t, e, i) {
		...
		for (const [r, [a, , l, h]] of Object.entries(ht)) {
			...
			o = ds(o, u[l] - o[l] + mn(s.target[r], h, u[a]) - mn(s.element[r], h, o[a]) + +n[r], r);
		}
		return o;
	}
	function ds(t, e, i) {
	...
	function Or(t, e, i, s) {
		...
		return (
			['auto', 'scroll'].includes(c(l, `overflow-${o}`)) &&
				((h[r] -= l[`scroll${It(r)}`]), (h[a] = h[r] + l[`scroll${It(n)}`])),
			(h[r] += i),
			(h[a] -= i),
			h
		);
		...
		methods: {
			start() {
				this.stop(),
					this.update(),
					this.timer ||
						(g(this.$el, 'countdownstart'), (this.timer = setInterval(this.update, 1e3)));
			},
			stop() {
				this.timer &&
					(clearInterval(this.timer), g(this.$el, 'countdownstop'), (this.timer = null));
			},
			update() {
				...
				for (const e of Fr) {
					...
					(s = s.length < 2 ? `0${s}` : s),
						i.textContent !== s &&
							((s = s.split('')),
							s.length !== i.children.length && Lt(i, s.map(() => '<span></span>').join('')),
	...
	(Y.events =
		...
		(Y.update = function (t, e) {
			return Fs(fs(t, et(e) ? { read: e } : e), 'order');
		}),
	...
	function Be(t, e, i) {
		const s = {};
		if ((et(e) && (e = e.options), e.extends && (t = Be(t, e.extends, i)), e.mixins))
	...
	const jr = /,(?![^(]*\))/;
	function Rr(t) {
		return Q(t) ? t : N(t) ? t.split(jr).map((e) => (vt(e) ? $t(e) : Fi(e.trim()))) : [t];
	}
	function qr(t) {
	...
	function Fe(t = {}) {
		return ze({
			handler: function (e, i) {
				...
				for (const o of C(et(s) ? s(this) : s))
					z('[loading="lazy"]', o)
						.slice(0, n - 1)
	...
	function ms(t) {
		return Le((e, i) => rs(i), t, 'resize');
	}
	function He(t) {
		return Le((e, i) => ({ disconnect: b(Xr(e), 'scroll', i, { passive: !0 }) }), t, 'scroll');
	}
	function yn(t) {
		return {
			observe(e, i) {
				return { observe: A, unobserve: A, disconnect: b(e, mt, i, { passive: !0 }) };
			},
			handler(e) {
				if (!kt(e)) return;
				const i = _t(e),
	...
	var kn = {
		...
		observe: [
			gs({ options: { childList: !0, attributes: !0, attributeFilter: ['style'] } }),
			ct({ target: ({ $el: t }) => [t, ...B(t)] })
		],
		update: {
			read() {
				return { rows: vs(Tt(this.$el.children)) };
			},
			write({ rows: t }) {
				for (const e of t)
					for (const i of e)
						j(i, this.margin, t[0] !== e), j(i, this.firstColumn, e[V ? e.length - 1 : 0] === i);
			},
			events: ['resize']
		}
	};
	...
	function Sn(t, e, i, s = 0) {
		const n = xi(e, !0),
			...
			l = a(async () => {
				$(e, bs),
					await Promise.all(
						Tn(e).map(
							(u, d) =>
								new Promise((f) => setTimeout(() => O.start(u, r, i / 2, 'ease').then(f), d * s))
						)
					),
					D(e, bs);
			}),
			h = a(async () => {
				const u = it(e);
				$(e, xs), t(), c(B(e), { opacity: 0 }), await Jr();
				const d = B(e),
					f = it(e);
				c(e, 'alignContent', 'flex-start'), it(e, u);
				const v = Tn(e);
				c(d, r);
				const x = v.map(async (T, M) => {
					await Kr(M * s), await O.start(T, o, i / 2, 'ease');
				});
				u !== f && x.push(O.start(e, { height: f }, i / 2 + v.length * s, 'ease')),
		...
		return y(e, bs) ? In(e).then(h) : y(e, xs) ? In(e).then(l).then(h) : l().then(h);
	}
	function xi(t, e) {
	...
	function In(t) {
		return Promise.all(
			B(t)
				.filter(O.inProgress)
				.map((e) => new Promise((i) => H(e, 'transitionend transitioncanceled', i)))
		);
	}
	function Tn(t) {
		return vs(B(t))
	...
	function Qr(t, e, i) {
		const s = e.map((o, r) =>
				P(o) && r in i ? (i[r] ? (q(o) ? En(o) : { opacity: 0 }) : { opacity: q(o) ? 1 : 0 }) : !1
			),
			n = s.map((o, r) => {
				const a = P(e[r]) === t && (i[r] || Cn(e[r]));
				if (!a) return !1;
	...
	function En(t) {
		...
		return { height: e, width: i, transform: '', ...ss(t), ...c(t, ['marginTop', 'marginLeft']) };
	}
	function Pn() {
		return new Promise((t) => requestAnimationFrame(t));
	}
		...
		methods: {
			...
			getState() {
				return this.toggles
					...
					.reduce((t, e) => Dn(e, this.attrItem, t), { filter: { '': '' }, sort: [] });
			},
			async setState(t, e = !0) {
				(t = { filter: { '': '' }, sort: [], ...t }), g(this.$el, 'beforeFilter', [this, t]);
	...
	function ra(t, e, i) {
		return [...t].sort(
			(s, n) => X(s, e).localeCompare(X(n, e), void 0, { numeric: !0 }) * (i === 'asc' || -1)
		);
	}
	function aa(t) {
	...
	function On(t) {
		...
		return (
			...
			() => {
				($s = !1), e(), c(i, { overflowY: '', touchAction: '', paddingRight: '' });
			}
		);
	}
	var We = {
			...
			methods: {
						...
						return (
							await Promise.all(
								C(t).map((s) => {
									...
									const o = (
											et(i) ? i : i === !1 || !this.hasAnimation ? la : this.hasTransition ? ha : ca
										)(s, n, this),
				...
				_toggle(t, e) {
					...
					this.cls
						...
						z('[autofocus]', t).some((s) => (q(s) ? s.focus() || !0 : s.blur())),
	...
	async function ha(t, e, { animation: i, duration: s, velocity: n, transition: o, _toggle: r }) {
		...
		s = (n * te + s) * (e ? 1 - Jo : Jo);
		const Ko = { [x]: e ? te : 0 };
		f && (c(t, T, te - wt + ge), (Ko[T] = e ? ge : te + ge)),
			!f ^ (l === 'reveal') && (c(Ni, T, -te + wt), O.start(Ni, { [T]: e ? 0 : -te }, s, o));
		try {
			await O.start(t, Ko, s, o);
		} finally {
			c(t, Bi), _e(Ni.firstChild), e || r(t, !1);
		}
	}
	function ca(t, e, i) {
		...
		events: [
			{
				...
				handler(t) {
					const { current: e, defaultPrevented: i } = t,
						{ hash: s } = e;
					!i && s && oe(e) && !this.$el.contains(k(s))
						? this.hide()
						: E(e, this.selClose) && (t.preventDefault(), this.hide());
				}
			},
			{
				name: 'toggle',
			...
			},
			{
				...
				handler() {
					...
					H(this.$el, 'hidden', () => t.forEach((e) => e && e()), { self: !0 }),
			...
			},
			{
				...
				handler() {
					ni(this.$el) || p(this.$el, 'tabindex', '-1'),
						E(this.$el, ':focus-within') || this.$el.focus();
				}
			},
			{
				name: 'hidden',
				...
				handler() {
					m(nt, this) && nt.splice(nt.indexOf(this), 1),
						c(this.$el, 'zIndex', ''),
						nt.some((t) => t.clsPage === this.clsPage) || D(document.documentElement, this.clsPage);
				}
			}
		],
		methods: {
		...
		return new Promise((n, o) =>
			H(t, 'show hide', () => {
				...
				const a = H(
						...
						'transitionstart',
						() => {
							H(i, 'transitionend transitioncancel', n, { self: !0 }), clearTimeout(l);
						},
						{ self: !0 }
					),
					l = setTimeout(() => {
		...
		return {
			...
			show(u, d = 0, f) {
				...
				return (
					...
					new Promise((x) => {
						h || (h = x),
							Promise.all([O.start(e, l[1], u, v), O.start(t, l[0], u, v)]).then(() => {
								this.reset(), h();
							}, A);
					})
				);
			...
			methods: {
				startAutoplay() {
					this.stopAutoplay(),
						(this.interval = setInterval(() => {
							this.stack.length ||
								(this.draggable && E(this.$el, ':focus-within') && !E(this.$el, ':focus')) ||
								(this.pauseOnHover && E(this.$el, ':hover')) ||
								this.show('next');
		...
		methods: {
			...
			move(t) {
				...
				if (
					...
					return;
				this.dragging || b(this.list, 'click', zn, Re),
				...
				for (const f of [this.index, this.prevIndex])
					m([o, s], f) || (g(i[f], 'itemhidden', [this]), u && ((d = !0), (this.prevIndex = s)));
				...
				if ((Pt(document, Ss, this.move, Re), Pt(document, Nn, this.end, Bn), this.dragging))
				...
				setTimeout(() => Pt(this.list, 'click', zn, Re)),
	...
	function $a(t, e) {
		for (const { name: i, handler: s, immediate: n = !0 } of t._watches)
			((t._initial && n) || (pt(e, i) && !ei(e[i], t[i]))) && s.call(t, t[i], e[i]);
		t._initial = !1;
	}
	function ya(t) {
	...
	function ka(t) {
		t._hasComputed &&
			(Ur(t, { read: () => $a(t, Wn(t)), events: ['resize', 'computed'] }), Ia(), qe.add(t));
	}
	function Sa(t) {
		qe == null || qe.delete(t), Wn(t);
	}
	function Wn(t) {
		const e = { ...t._computed };
	...
	function Ia() {
		Is ||
			...
			(Is = new MutationObserver(() => {
				for (const t of qe) Ne(t, 'computed');
			})),
	...
	function jn(t, e, i) {
		...
		(n = et(n) ? n.call(t, t) : n || t.$el),
			!(!n || (Q(n) && !n.length) || (h && !h.call(t))) &&
				t._events.push(
					b(n, s, l ? (N(l) ? l : l.call(t, t)) : null, N(o) ? t[o] : o.bind(t), {
						passive: a,
						capture: r,
						self: u
					})
	...
	function qn(t, e) {
		...
		const h = pt(t, l) ? t[l] : s,
			u = i(h, n, o, a);
		et(s) && Q(t[l]) && u.unobserve && Hn(t, { handler: _a(u), immediate: !1 }, l), Rn(t, u);
	}
	function _a(t) {
		return (e, i) => {
	...
	function Un(t) {
		...
		for (const a in s) {
			...
			let h = X(n, l);
			G(h) ||
				((h = s[a] === Boolean && h === '' ? !0 : ps(s[a], h)),
				!(l === 'target' && dt(h, '_')) && (e[a] = h));
		}
		const r = ce(X(n, o), i);
		for (const a in r) {
			const l = we(a);
			G(s[l]) || (e[l] = ps(s[l], r[a]));
		}
		return e;
	}
	const Da = rt((t, e) => {
		...
		const { attributes: r, filter: a } = Da(s, n),
			l = new MutationObserver((h) => {
				...
				h.some(({ attributeName: d }) => {
					...
					return (f === s ? r : [we(f), we(d)]).some((v) => !G(u[v]) && u[v] !== i[v]);
				}) && t.$reset();
			});
	...
	function za({ data: t = {} }, { args: e = [], props: i = {} }) {
		Q(t) &&
			(t = t.slice(0, e.length).reduce((s, n, o) => (xt(n) ? gt(s, n) : (s[e[o]] = n), s), {}));
		for (const s in t) G(t[s]) ? delete t[s] : i[s] && (t[s] = ps(i[s], t[s]));
		return t;
	}
	const ut = function (t) {
		Vn(this, t);
	};
	(ut.util = zr), (ut.options = {}), (ut.version = '3.18.3');
	const Fa = 'uk-',
		Gt = '__uikit__',
		fe = {};
	function Yn(t, e) {
		...
		(t = we(t)), (ut[t] = (o, r) => Ue(t, o, r));
		const n = xt(e) ? { ...e } : e.options;
		return (
			(n.id = s),
			(n.name = t),
			(i = n.install) == null || i.call(n, ut, n, t),
			ut._initialized && !n.functional && requestAnimationFrame(() => Ue(t, `[${s}],[data-${s}]`)),
			(fe[s] = n)
		);
	}
	function Ue(t, e, i, ...s) {
	...
	function La(t, e) {
		var i;
		(i = t[Gt]) == null || delete i[e.$options.name], ti(t[Gt]) || delete t[Gt];
	}
	function Wa(t) {
		(t.component = Yn),
			(t.getComponents = Xt),
			...
			(t.mixin = function (i, s) {
				(s = (N(s) ? this.component(s) : s) || this), (s.options = Be(s.options, i));
			}),
			(t.extend = function (i) {
				i || (i = {});
				const s = this,
	...
	function Xn(t, e) {
		const i = Xt(t);
		for (const s in i) Ne(i[s], e);
	}
	function ja(t) {
		(t.prototype.$mount = function (e) {
			const i = this;
			Ha(e, i), (i.$options.el = e), document.contains(e) && Ts(i);
		}),
				...
				navItems(t) {
					for (const e of t) {
						...
						if (vt(i)) {
							...
							this.list &&
								(this.list.id || (this.list.id = Jt(this, this.list)), (o = this.list.id)),
								(n = this.t(i));
					...
					for (const e of this.navItems) {
						...
						if (vt(i)) {
							...
							j(e, this.clsActive, o),
								...
								p(s, { 'aria-selected': o, tabindex: o && !this.parallax ? null : -1 }),
			...
			methods: {
				show(t, e = !1) {
					...
					if (
						...
						(this.prevIndex = r),
						(this.index = l),
						(a && !g(a, 'beforeitemhide', [this])) || !g(h, 'beforeitemshow', [this, a]))
					) {
	...
	var Zn = {
		...
		to = {
			...
			events: [
				{ name: `${pi} ${mt} keydown`, handler: 'showControls' },
				{
					name: 'click',
					self: !0,
					delegate() {
				...
				},
				{
					...
					async handler(t, e) {
						...
						if (s === 'image' || i.match(/\.(avif|jpe?g|jfif|a?png|gif|svg|webp)($|\?)/i)) {
							...
							this.setItem(
								e,
								Ve('iframe', { src: i, allowfullscreen: '', class: 'uk-lightbox-iframe', ...r })
							);
						else if (
							(a = i.match(
	...
	var Ga = {
		...
		created() {
			const t = `${this.clsContainer}-${this.pos}`,
				...
				i =
					...
					L(this.container, `<div class="${this.clsContainer} ${t}" ${e}></div>`);
			this.$mount(
				L(
					i,
		...
		async connected() {
			...
			await O.start(c(this.$el, this.startProps), { opacity: 1, [this.marginProp]: t }),
	...
	function Ti(t, e, i) {
		...
		return (
			t === 'x' || t === 'y'
				? ((t = `translate${It(t)}`), (n = (o) => S(S(o).toFixed(s === 'px' ? 0 : 6))))
				: t === 'scale' &&
				  ((s = ''),
				  (n = (o) => {
						var r;
			...
			(i = pe(i, n)),
			(o, r) => {
				o.transform = `${o.transform || ''} ${t}(${Ye(i, r)}${s})`;
			}
		);
	}
	function Es(t, e, i) {
		return (
			i.length === 1 && i.unshift(Ge(e, t, '')),
			(i = pe(i, (s) => Ka(e, s))),
			(s, n) => {
				const [o, r, a] = lo(i, n),
					l = o.map((h, u) => ((h += a * (r[u] - h)), u === 3 ? S(h) : parseInt(h, 10))).join(',');
				s[t] = `rgba(${l})`;
			}
		);
	}
	function Ka(t, e) {
		return Ge(t, 'color', e).split(/[(),]/g).slice(1, -1).concat(1).slice(0, 4).map(S);
	}
	function Kt(t, e, i) {
	...
	function oo(t, e, i, s) {
		...
		if (Ge(e, 'backgroundSize', '') === 'cover') return tl(t, e, i, s);
		const r = {};
	...
	function tl(t, e, i, s) {
		...
		for (const u of r) {
			const d = s[u].map(([M]) => M),
				...
				T = v - f;
			(a[u] = `${(x ? -T : 0) - (x ? f : v)}px`), (o[u === 'bgy' ? 'height' : 'width'] += T);
		}
	...
	function ro(t, e) {
		return Ge(t, `background-position-${e.substr(-1)}`, '');
	}
	function ao(t, e, i) {
		return function (s, n) {
			for (const o of t) {
	...
	var fo = {
		...
		observe: [
			ct({ target: ({ $el: t, parallaxTarget: e }) => [t, e], filter: ({ parallax: t }) => t }),
			He({ filter: ({ parallax: t }) => t })
		],
		computed: {
		...
		update: {
			write() {
				...
				const t = this.parallaxTarget,
					...
					a = this.slides[n],
					l = this.slides[r],
					{ triggerShow: h, triggerShown: u, triggerHide: d, triggerHidden: f } = nl(this);
				if (~this.prevIndex)
	...
	var po = {
		...
		go = {
			observe: Fe({ target: ({ slides: t }) => t, targets: (t) => t.getAdjacentSlides() }),
			methods: {
				getAdjacentSlides() {
	...
	function ol(t, e, i, { center: s, easing: n, list: o }) {
		const r = t ? Xe(t, o, s) : Xe(e, o, s) + w(e).width * i,
			a = e ? Xe(e, o, s) : r + w(t).width * i * (V ? -1 : 1);
		let l;
		return {
			dir: i,
			show(h, u = 0, d) {
				...
				return (
					...
					this.translate(u),
					(u = t ? u : tt(u, 0, 1)),
					_s(this.getItemIn(), 'itemin', { percent: u, duration: h, timing: f, dir: i }),
					t &&
						_s(this.getItemIn(!0), 'itemout', { percent: 1 - u, duration: h, timing: f, dir: i }),
					new Promise((v) => {
						l || (l = v), O.start(o, { transform: W(-a * (V ? -1 : 1), 'px') }, h, f).then(l, A);
					})
				);
			},
			cancel() {
			...
			translate(h) {
				...
				c(o, 'transform', W(tt(-a + (u - u * h), -Je(o), w(o).width) * (V ? -1 : 1), 'px'));
				...
				for (const x of B(o)) {
					const T = m(d, x),
						M = x === f,
						wt = x === v,
						Ze = M || (!wt && (T || (i * (V ? -1 : 1) === -1) ^ (Pi(x, o) > Pi(t || e))));
					_s(x, `itemtranslate${Ze ? 'in' : 'out'}`, {
						dir: i,
						percent: wt ? 1 - h : M ? h : T ? 1 : 0
					});
				}
			},
			percent() {
	...
	function mo(t) {
		return Math.max(0, Je(t) - w(t).width);
	}
	function Je(t) {
		return zt(B(t), (e) => w(e).width);
	}
	function rl(t, e) {
		return w(e).width / 2 - w(t).width / 2;
	}
	function Pi(t, e) {
		return (t && (ss(t).left + (V ? w(t).width - w(e).width : 0)) * (V ? -1 : 1)) || 0;
	}
	function vo(t, e) {
		e -= 1;
		const i = w(t).width,
	...
	var al = {
			...
			sets({ sets: t }) {
				...
				for (let n = 0; n < this.length; n++) {
					...
					e + o > s && (e = 0),
						this.center
							? e < s / 2 &&
							  e + o + w(this.slides[ot(+n + 1, this.slides)]).width / 2 > s / 2 &&
							  (i.push(+n), (e = s / 2 - o / 2))
		...
		update: {
			write() {
				for (const t of this.navItems) {
					...
					e !== !1 &&
						(t.hidden = !this.maxIndex || e > this.maxIndex || (this.sets && !m(this.sets, e)));
				}
		...
		methods: {
			reorder() {
				...
				if (
					(this.slides.forEach((n, o) =>
						c(n, 'order', this.dir > 0 && o < t ? 1 : this.dir < 0 && o >= this.index ? -1 : '')
					),
					!this.center)
				)
					return;
			...
			updateActiveClasses(t = this.index) {
				const e = this._getTransitioner(t).getActives(),
					i = [this.clsActive, !this.sets || m(this.sets, S(this.index)) ? this.clsActivated : ''];
				for (const s of this.slides) {
					const n = m(e, s);
					j(s, i, n), p(s, 'aria-hidden', !n);
					for (const o of z(Se, s))
			...
			getIndexAt(t) {
				let e = -1;
				const i = w(this.slides[0]).width,
					s = w(Bt(this.slides)).width,
					n = Je(this.list) - (this.center ? i / 2 + s / 2 : s);
				let o = t * n,
					r = 0;
				do {
					const a = w(this.slides[++e]).width,
						l = this.center ? a / 2 + w(this.slides[e + 1]).width / 2 : a;
					(r = (o / l) % 1), (o -= l);
	...
	function ll(t, e) {
		...
		const { width: i } = w(t);
		if (!e) return Math.ceil(Je(t)) < Math.trunc(i + hl(t));
		const s = B(t),
			n = Math.trunc(i / 2);
		for (const o in s) {
			const r = s[o],
			...
			methods: {
				init(t) {
					...
					!n ||
						...
						(this.placeholder = n),
						(this.origin = { target: e, index: Et(n), ...this.pos }),
				...
				start(t) {
					...
					gt(this.origin, { offsetLeft: this.pos.x - e, offsetTop: this.pos.y - i }),
				...
				move(t) {
					...
					this === t
						? this.origin.index !== Et(this.placeholder) &&
	...
	var ko = {
		...
		data: { pos: `bottom-${V ? 'right' : 'left'}`, offset: !1, flip: !0, shift: !0, inset: !1 },
		connected() {
		...
		methods: {
			...
			getShiftOffset(t = this.$el) {
				return this.align === 'center'
					? 0
					: U(c(t, '--uk-position-shift-offset'), this.axis === 'y' ? 'width' : 'height', t) *
		...
		methods: {
			show() {
				...
				const i = p(this.$el, 'title'),
					s = b(this.$el, ['blur', Oe], (o) => !kt(o) && this.hide());
				this.reset = () => {
					...
					b(this.tooltip, 'toggled', (i, s) => {
						...
						const a = [
							H(
								...
								!1,
								(l) =>
									(l.type === mt && !this.$el.contains(l.target)) ||
									(l.type === 'keydown' && l.keyCode === _.ESC)
							),
							b([document, ...Vt(this.$el)], 'scroll', n, { passive: !0 })
						];
	...
	function Io(t) {
		g(document, 'uikit:init', t),
			document.body && St(document.body, To),
			new MutationObserver((e) => e.forEach(_l)).observe(document, { subtree: !0, childList: !0 }),
			new MutationObserver((e) => e.forEach(Al)).observe(document, { subtree: !0, attributes: !0 }),
			(t._initialized = !0);
	}
	function _l({ addedNodes: t, removedNodes: e }) {
		for (const i of t) St(i, To);
		for (const i of e) St(i, Dl);
	}
		...
		events: [
			{
				...
				async handler(t) {
					...
					(t.type === 'keydown' && t.keyCode !== _.SPACE) ||
						...
						await this.toggle(Et(this.toggles, t.current)),
						this._off());
				}
			},
			{
	...
	var Po = {
			...
			connected() {
				this.autoplay === 'inview' && !yt(this.$el, 'preload') && (this.$el.preload = 'none'),
					R(this.$el, 'iframe') && !yt(this.$el, 'allow') && (this.$el.allow = 'autoplay'),
			...
			observe: [
				ze({
					...
					handler([{ isIntersecting: t }]) {
						t || this.$el.webkitDisplayingFullscreen || document.fullscreenElement === this.$el
							? nn(this.$el)
							: on(this.$el);
					},
					args: { intersecting: !1 },
					options: ({ $el: t, autoplay: e }) => ({ root: e === 'inview' ? null : P(t) })
				})
			]
		},
		zl = {
			...
			observe: ct({ target: ({ $el: t }) => [_o(t) || P(t)], filter: ({ $el: t }) => !Ao(t) }),
			update: {
				read() {
	...
	var Do = {
		...
		connected() {
			$(this.$el, 'uk-drop', this.clsDrop),
				...
				(this._style = Li(this.$el.style, ['width', 'height']));
		},
		disconnected() {
			this.isActive() && (this.hide(!1), (Z = null)), c(this.$el, this._style);
		},
		observe: Fe({ target: ({ toggle: t, $el: e }) => J(t, e), targets: ({ $el: t }) => t }),
		events: [
			{
				name: 'click',
				delegate() {
				...
				for (const [n, [o, r, a, l]] of i)
					if (this.axis === o && m([o, !0], this.stretch)) {
						...
						c(this.$el, {
							[r]:
								(u[a] > d[a]
									? u[this.inset ? l : a] - Math.max(I(this.boundary[n])[a], t[n][a] + e)
									: Math.min(I(this.boundary[n])[l], t[n][l] - e) - u[this.inset ? a : l]) - h,
							[`overflow-${o}`]: 'auto'
						}),
							this.positionAt(this.$el, this.target, this.boundary);
					}
	...
	function Hl(t, e) {
		return lt(Vt(e).find((i) => i.contains(t)));
	}
	function Ll(t) {
		const { $el: e } = t.$create('toggle', J(t.toggle, t.$el), { target: t.$el, mode: t.mode });
		return p(e, 'aria-haspopup', !0), e;
	}
	function Wl(t) {
		const e = () => t.$emit(),
			i = [rs(e), Me(Vt(t.$el).concat(t.target), e)];
		return () => i.map((s) => s.disconnect());
	}
	function Oo(t, e = () => t.$emit()) {
		return b([document, ...Vt(t.$el)], 'scroll', e, { passive: !0 });
	}
	function jl(t) {
		return b(document, 'keydown', (e) => {
	...
	var Mo = {
		...
		computed: {
			...
			dropbar({ dropbar: t }) {
				return t
					? ((t = this._dropbar || J(t, this.$el) || k(`+ .${this.clsDropbar}`, this.$el)),
		...
		events: [
			...
			},
			{
				...
				handler(t) {
					...
					s === _.DOWN &&
						...
						(t.preventDefault(), (e = k(Se, n.$el)) == null || e.focus()),
						Bo(t, this.items, n);
				}
			},
			{
			...
			},
			{
				...
				handler({ target: t }) {
					...
					(this._observer = Me([e.$el, ...e.target], i)), i();
				}
			},
			{
				name: 'beforehide',
				...
				handler(t) {
					const e = this.getActive();
					E(this.dropbar, ':hover') &&
						e.$el === t.target &&
						this.isDropbarDrop(e.$el) &&
						m(e.mode, 'hover') &&
						e.isDelayedHide &&
						!this.items.some((i) => e.targetEl !== i && E(i, ':focus')) &&
						t.preventDefault();
				}
			},
			{
	...
	var Ul = {
			...
			computed: {
				...
				target({ target: t }, e) {
					return (
						t && ((t === !0 && P(this.input) === e && this.input.nextElementSibling) || k(t, e))
					);
				}
			},
			update() {
				...
				if (!e) return;
				let s;
				const n = Vi(e) ? 'value' : 'textContent',
					o = e[n],
					r =
						(t = i.files) != null && t[0]
							? i.files[0].name
							: E(i, 'select') && (s = z('option', i).filter((a) => a.selected)[0])
							? s.textContent
							: i.value;
				o !== r && (e[n] = r);
			},
		...
		Vl = {
			...
			observe: He({ filter: ({ parallax: t, parallaxJustify: e }) => t || e }),
			update: [
				{
					write({ rows: t }) {
				...
				},
				{
					read(t) {
						...
						if (
							...
							!(i || s || n) ||
								No(e) ||
								e[0].some((x, T) => e.some((M) => M[T] && M[T].offsetWidth !== x.offsetWidth)))
						)
						...
						return (
							(s || n) &&
								((d = h.map((x, T) => (n ? u - x + s : s / (T % 2 || 8)))),
								n || (s = Math.max(...h.map((x, T) => x + d[T] - u))),
	...
	var Jl = {
		...
		update: {
			read() {
				return { rows: (this.row ? vs(this.elements) : [this.elements]).map(Kl) };
			},
			write({ rows: t }) {
	...
	function Zl(t) {
		const e = Li(t.style, ['display', 'minHeight']);
		q(t) || c(t, 'display', 'block', 'important'), c(t, 'minHeight', '');
		const i = w(t).height - Ae(t, 'height', 'content-box');
		return c(t, e), i;
	}
	var Ql = {
			args: 'target',
		...
		th = {
			...
			observe: [ms({ filter: ({ expand: t }) => t }), ct({ target: ({ $el: t }) => Ut(t) })],
			update: {
				read() {
					...
					if (((t = `calc(${r ? '100vh' : `${o}px`}`), this.expand)) {
						...
						this.offsetBottom === !0
							...
							: N(this.offsetBottom) && (t += ` - ${w(J(this.offsetBottom, this.$el)).height}px`);
					}
		...
		Fo = {
			...
			connected() {
				this.svg = this.getSvg().then((t) => {
					...
					return (
						this.svgEl && e !== this.svgEl && at(this.svgEl), $h.call(this, e, t), (this.svgEl = e)
					);
				}, A);
			},
			disconnected() {
				this.svg.then((t) => {
					this._connected || (Ui(this.$el) && (this.$el.hidden = !1), at(t), (this.svgEl = null));
				}),
					(this.svg = null);
			},
	...
	const Di = {
		...
		Sh = {
			...
			methods: {
				async getSvg() {
					const t = await Ds.methods.getSvg.call(this);
		...
		Qt = {
			...
			beforeConnect() {
				...
				e && !yt(t, 'aria-label') && p(t, 'aria-label', e);
			}
		},
		Lo = {
			extends: Qt,
		...
		Ih = { extends: Qt, i18n: { label: 'Open menu' } },
		Th = {
			extends: Qt,
			i18n: { label: 'Close' },
			beforeConnect() {
		...
		Ch = { extends: Qt, i18n: { label: 'Open' } },
		Eh = { extends: Qt, i18n: { label: 'Back to top' } },
		Ph = { extends: Qt, i18n: { label: 'Next page' }, data: { role: null } },
		_h = { extends: Qt, i18n: { label: 'Previous page' }, data: { role: null } },
		Oi = {};
	function Ah(t) {
		t.icon.add = (e, i) => {
			const s = N(e) ? { [e]: i } : e;
	...
	function Oh(t) {
		return (
			(t = Dh[t] || t),
			Di[t] ? (Oi[t] || (Oi[t] = k((Di[Mh(t)] || Di[t]).trim())), Oi[t].cloneNode(!0)) : null
		);
	}
	function Mh(t) {
		return V ? Hi(Hi(t, 'left', 'right'), 'previous', 'next') : t;
	}
	const Bh = qt && 'loading' in HTMLImageElement.prototype;
	var Nh = {
		args: 'dataSrc',
		...
		connected() {
			...
			Bh && Mi(this.$el) && ((this.$el.loading = 'lazy'), Os(this.$el)), Wh(this.$el);
		},
		disconnected() {
		...
		methods: {
			load() {
				...
				const t = Mi(this.$el) ? this.$el : Fh(this.$el, this.dataSrc, this.sources);
				return ye(t, 'loading'), Os(this.$el, t.currentSrc), (this.img = t);
			}
		}
	};
	function Os(t, e) {
		...
		} else e && !m(t.style.backgroundImage, e) && (c(t, 'backgroundImage', `url(${Xi(e)})`), g(t, Ht('load', !1)));
	}
	const zh = ['data-src', 'data-srcset', 'sizes'];
	function Wo(t, e) {
		for (const i of zh) {
			const s = X(t, i);
	...
	var jh = {
		...
		observe: [
			...
			}),
			{
				target: ({ target: t }) => t,
				observe: (t, e) => {
					const i = Me([...t, document.documentElement], e),
						s = [
							b(document, 'scroll itemshown itemhidden', e, { passive: !0, capture: !0 }),
		...
		update: {
			read() {
				for (const t of this.target)
					si(t, 'uk-light,uk-dark', !this.selActive || E(t, this.selActive) ? Rh(t) : '');
			}
		}
	};
	function Rh(t) {
		...
		for (const r of [0.25, 0.5, 0.75]) {
			...
			for (const l of a) {
				if (
					t.contains(l) ||
					(l.closest('[class*="-leave"]') && a.some((u) => l !== u && E(u, '[class*="-enter"]')))
				)
					continue;
	...
	var Yh = { extends: Eo, data: { targets: '> .uk-parent', toggle: '> a', content: '> ul' } };
	...
	var Gh = {
		...
		watch: {
			items() {
				...
				for (const i of e) {
					const s = t
						? z('.uk-navbar-nav > li > a, .uk-navbar-item, .uk-navbar-toggle', i).length
						: '';
					c(i, 'flexGrow', s);
				}
			}
				...
				async scrollTo(t) {
					(t = (t && k(t)) || document.body),
						g(this.$el, 'beforescroll', [this, t]) &&
							(await un(t, { offset: this.offset }), g(this.$el, 'scrolled', [this, t]));
				}
			}
		};
	const Ke = new Set();
	...
	var nc = {
				...
				toggle(t, e) {
					...
					if (s) {
						if (
							...
							const n = () => qi(t, 'uk-animation-[\\w-]+');
							e ? (s.off = H(t, 'animationcancel animationend', n, { self: !0 })) : n();
						}
		...
		oc = {
			...
			update: [
				{
					read() {
						const t = this.links.map(Yi).filter(Boolean),
							{ length: e } = t;
		...
		rc = {
			...
			observe: [
				...
				He({ target: () => document.scrollingElement }),
				ct({ target: () => document.scrollingElement, options: { box: 'content-box' } }),
				ct({ target: ({ $el: t }) => t })
			],
			events: [
				{
			...
			update: [
				{
					read({ height: t, width: e, margin: i, sticky: s }) {
						...
						n && (Ns(this.target), this.hide()),
							this.active || (({ height: t, width: e } = I(this.$el)), (i = c(this.$el, 'margin'))),
							n && this.show();
						...
						const d = this.overflowFlip ? 0 : Math.max(0, t + u - o),
							...
							T = this.end === !1 ? a : Math.min(a, Bs(this.end, this.$el, f + t, !0) - v - u + d);
						return (
							(s =
								a &&
								!this.showOnUp &&
								x + u === f &&
								T === Math.min(a, Bs(!0, this.$el, 0, !0) - v - u + d) &&
					...
					write({ height: t, width: e, margin: i, offset: s, sticky: n }) {
						...
						c(o, { height: t, width: e, margin: i }),
							(P(o) !== P(this.$el) || n ^ (Et(o) < Et(this.$el))) &&
				...
				},
				{
					...
					write(t, e) {
						...
						const d = Date.now();
						if (
							((d - s > 300 || n !== o) && ((t.initScroll = r), (t.initTimestamp = d)),
							!(
								this.showOnUp &&
								!this.isFixed &&
							...
							if (
								...
								r < h ||
								(this.showOnUp &&
									(r <= h || (n === 'down' && i) || (n === 'up' && !this.isFixed && !u)))
							) {
								if (!this.isFixed) {
			...
			methods: {
				...
				hide() {
					...
					this.setActive(!1),
						...
						e
							? c(this.$el, 'top', t)
							: c(this.$el, { position: '', top: '', width: '', marginTop: '' }),
				...
				update() {
					...
					if (!l) {
						...
						e > o && ((r += o - a + s - i), (d = 'absolute')),
							c(this.$el, { position: d, width: t, marginTop: 0 }, 'important');
					}
					c(this.$el, 'top', r - s),
						this.setActive(u),
	...
	var ac = {
		...
		async connected() {
			...
			const t = await this.svg;
			t && (Vo.call(this, t), this.strokeAnimation && uc(t));
		},
		methods: {
			async getSvg() {
				return (
					...
					hc(await lc(this.src), this.icon) || Promise.reject('SVG not found.')
				);
			}
		}
	};
			...
			methods: {
				...
				show(t) {
					...
					this.children.forEach((r, a) => {
						j(r, this.cls, n === a),
							p(this.toggles[a], { 'aria-selected': n === a, tabindex: n === a ? null : -1 });
					});
					const o = i >= 0 && i !== s;
					this.connects.forEach(async ({ children: r }) => {
						const a = Tt(r).filter((l, h) => h !== n && y(l, this.cls));
			...
			events: [
				{
					...
					handler(t) {
						(this._preventClick = null),
							!(!kt(t) || se(this._showState) || this.$el.disabled) &&
								(g(this.$el, 'focus'),
								H(
									document,
									mt,
				...
				{
					name: `mouseenter mouseleave ${he} ${Oe} focus blur`,
					filter() {
						return m(this.mode, 'hover');
					},
					handler(t) {
						if (kt(t) || this.$el.disabled) return;
						const e = m(['mouseenter', he, 'focus'], t.type),
							i = this.isToggled(this.target);
						if (
							!e &&
							(!se(this._showState) ||
								(t.type !== 'blur' && E(this.$el, ':focus')) ||
								(t.type === 'blur' && E(this.$el, ':hover')))
						) {
							i === this._showState && (this._showState = null);
							return;
						}
						(e && se(this._showState) && i !== this._showState) ||
				...
				},
				{
					...
					handler(t) {
						t.keyCode === fc && (t.preventDefault(), this.$el.click());
					}
				},
				{
					name: 'click',
					...
					handler(t) {
						...
						(this._preventClick ||
							...
							((e = t.target.closest('a[href]')) &&
								(!this.isToggled(this.target) || (e.hash && E(this.target, e.hash))))) &&
							t.preventDefault(),
	...
	return Nt(gc, (t, e) => ut.component(e, t)), Pl(ut), Nt(El, (t, e) => ut.component(e, t)), ut;
});
